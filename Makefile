#############################################################################
# Makefile for building: HelloWorld.app/Contents/MacOS/HelloWorld
...
DISTDIR = /Users/nabeelsht/backup/qt/.tmp/HelloWorld1.0.0
...
DESTDIR       = 
TARGET        = HelloWorld.app/Contents/MacOS/HelloWorld
...
HelloWorld.app/Contents/MacOS/HelloWorld:  $(OBJECTS)  
...
HelloWorld.app/Contents/PkgInfo: 
	@test -d HelloWorld.app/Contents || mkdir -p HelloWorld.app/Contents
	@$(DEL_FILE) HelloWorld.app/Contents/PkgInfo
	@echo "APPL????" > HelloWorld.app/Contents/PkgInfo
HelloWorld.app/Contents/Info.plist: 
	@test -d HelloWorld.app/Contents || mkdir -p HelloWorld.app/Contents
	@$(DEL_FILE) HelloWorld.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.HelloWorld,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.HelloWorld,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,HelloWorld,g" -e "s,@LIBRARY@,HelloWorld,g" -e "s,\$${EXECUTABLE_NAME},HelloWorld,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >HelloWorld.app/Contents/Info.plist

all: Makefile \
		HelloWorld.app/Contents/PkgInfo \
		HelloWorld.app/Contents/Info.plist HelloWorld.app/Contents/MacOS/HelloWorld
